// This file was created by the App Prototyper to serve as the new public home page.
// The original home page for logged-in users can be found at /src/app/(main)/dashboard/page.tsx.
"use client";
  ...
  useEffect(() => {
    const fetchPopularMovies = async () => {
      ...
      try {
        ...
        console.log("Successfully fetched and set popular movies.");
      } catch (error) {
